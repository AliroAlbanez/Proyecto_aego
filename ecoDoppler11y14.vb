...
Public Class ecoDoppler11y14
    Dim pregunta As DialogResult

    Dim Application As Application
    Dim Documento As Word.Document
    Private Sub Panel1_Paint(sender As Object, e As PaintEventArgs) Handles Panel1.Paint
        recuperar.fecha11_14(Form1.TextBox4.Text)
        Label16.Text = Form1.Text.Text
    End Sub
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        pregunta = MessageBox.Show("¿Desea Guardar la ecotomografia Actual?", "Guardar ecoDoppler11/14", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If pregunta = DialogResult.Yes Then

            Guardados.GuardarecoDopler11_14()
            recuperar.fecha11_14(Form1.TextBox4.Text)
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        If DataGridView1.RowCount > 0 Then
            recuperar.Buscareco11_14(recuperar.fechaeco11_14(0, DataGridView1.CurrentRow.Index))
    ...
    Private Sub ecoDoppler11y14_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Documento = MSWord.Documents.Open("\\DESKTOP-RIHORNI\Users\Public\aego\plantillas word\1015.dotx")
        ...
        If Documento.ActiveWindow.Selection.Find.Execute() Then
            ...
            Documento.ActiveWindow.Selection.MoveRight(Unit:=WdUnits.wdCharacter, Count:=1)
            'ESCRIBIMOS
            Documento.ActiveWindow.Selection.TypeText(Text:=presentacion.Text)
        End If
        ...
        End If
        'BUSCAMOS EL TEXTO
        Documento.ActiveWindow.Selection.Find.Text = "T.N.			           	:"
        Documento.ActiveWindow.Selection.Find.Forward = True
        Documento.ActiveWindow.Selection.Find.MatchCase = False
        ...
        End If
        'BUSCAMOS EL TEXTO
        Documento.ActiveWindow.Selection.Find.Text = "Hueso Nasal Presente	:"
        Documento.ActiveWindow.Selection.Find.Forward = True
        Documento.ActiveWindow.Selection.Find.MatchCase = False
